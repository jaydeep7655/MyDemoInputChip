...
public class DetailedChipView extends RelativeLayout {
    ...
    public void setInfo(String info) {
        if (info != null) {
            ...
            mUserNameTextView.setText(info);
        } else {
    ...
    public void setTextColor(ColorStateList color) {
        ...
        mUserNameTextView.setTextColor(ColorUtil.alpha(color.getDefaultColor(), 150));
    }
    ...
    public static class Builder {
        ...
        public Builder chip(ChipInterface chip) {
            ...
            this.UserName = chip.getUserName();
            return this;
        }
    ...
    private static DetailedChipView newInstance(Builder builder) {
        ...
        detailedChipView.setName(builder.FullName);
        detailedChipView.setInfo(builder.UserName);
