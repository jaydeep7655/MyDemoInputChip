...
public class ChipsInput extends ScrollViewMaxHeight {
    ...
    private ColorStateList mChipFullNameColor;
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            try {
                ...
                // chip FullName color
                mChipFullNameColor = a.getColorStateList(R.styleable.ChipsInput_chip_labelColor);
                // chip avatar icon
                // chip delete icon
    ...
    public void addChip(Object userIndex, String fullName, String userName, String userDepartment) {
        Chip chip = new Chip(userIndex, fullName, userName, userDepartment);
        mChipsAdapter.addChip(chip);
    }

    public void addChip(Object userIndex, String fullName, String userName) {
        Chip chip = new Chip(userIndex, fullName, userName);
        mChipsAdapter.addChip(chip);
    }

    public void addChip(Object userIndex, String fullName) {
        ChipInterface chip = new Chip(userIndex, fullName);
        mChipsAdapter.addChip(chip);
    }
    ...
    public void removeChipByFullName(String FullName) {
        mChipsAdapter.removeChipByFullName(FullName);
    }
    ...
    public ChipView getChipView() {
        ...
        ChipView chipView = new ChipView.Builder(mContext)
                .FullNameColor(mChipFullNameColor)
    ...
    public void setChipFullNameColor(ColorStateList mFullNameColor) {
        this.mChipFullNameColor = mFullNameColor;
    }
